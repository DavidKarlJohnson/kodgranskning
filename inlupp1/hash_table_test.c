...
void test_hashtable_keys(){
  ...
  elem_t keys[5] = {string_elem("hej"), string_elem("hopp"), string_elem("kung"), string_elem("ojoj"), string_elem("a")};
  bool found[5] = {false};
   ioopm_hash_table_t *ht = ioopm_hash_table_create(hash_function_mod_INT, eq_int, eq_int);
...
void test_hash_string_key()
{
  ...
  ioopm_hash_table_insert(ht, string_elem("Test"), int_elem(10));
  ioopm_hash_table_insert(ht, string_elem("test"), int_elem(11));
  ioopm_hash_table_insert(ht, string_elem("Toxts"), int_elem(22));
  ioopm_hash_table_insert(ht, string_elem("HEJHopp123"), int_elem(11));
  ioopm_hash_table_insert(ht, string_elem("789OJ"), int_elem(33));
  CU_ASSERT_TRUE(ioopm_hash_table_lookup(ht, string_elem("Test"), &result));
