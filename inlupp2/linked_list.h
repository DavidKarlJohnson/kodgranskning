...
/// The valid values of index are [0,n-1] for a list of n elements,
/// where 0 means the firs  t element and n-1 means the last element.
/// @param list the linked list that will be extended
/// @param index the position in the list
/// @param result Used to recive the value of the link at said index
...
/// @brief Find the index of the given element within a linked list
/// @param list The linked list to search
/// @param element The element to find
/// @return The index position of the element. If the element is not found, -1 is returned
